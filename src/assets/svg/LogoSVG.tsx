...
interface LogoSVGProps {
  width?: number;
  height?: number;
  /** 'default' usa as cores originais; 'white' força tudo branco (para fundos coloridos) */
...
const LogoSVG: React.FC<LogoSVGProps> = ({
  ...
  const styles = {
    ...
    cls4: {
      fill: isWhite ? "#ffffff" : "#4e342e",
      fontSize: "60px",
    },
    cls5: {
      fill: isWhite ? "#ffffff" : "#ed6f1d",
    },
    cls6: {
  ...
  return (
    ...
    >
      <g>
        ...
        <path
          style={styles.cls6}
          d="M82.51,32.98h-6.18c0-5.87-4.77-10.64-10.64-10.64s-10.64,4.77-10.64,10.64h-6.18c0-9.27,7.54-16.81,16.81-16.81s16.81,7.54,16.81,16.81Z"
        />
      </g>
